(define (domain blocksword)
    ...
    (:action coger
        ...
        :effect (and (sujeto ?ob) (not (sin_nada_encima ?ob)) (not (encima_mesa ?ob))(not (brazo_libre)))
    )
    (:action soltar
        :parameters (?ob)
    ...
    (:action desapilar
        ...
        :effect (and (sujeto ?ob) (sin_nada_encima ?underob) (not (encima_bloque ?ob ?underob)) (not (sin_nada_encima ?ob)) (not (brazo_libre)))
    )
)